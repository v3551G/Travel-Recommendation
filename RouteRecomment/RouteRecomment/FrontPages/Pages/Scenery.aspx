<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Scenery.aspx.cs" Inherits="RouteRecomment.FrontPages.Pages.Scenery" %>
...
$(function(){
	...
	if(defHeight >= slideHeight){
		...
		$('#read-more').append('<a href="#">查看全文<<</a>');
...
<div class="all">
	<div class="header">
	<div class="place">
		您的位置：<a href="">首页</a><<<a href="">桂林</a><<<a href="">漓江</a>
	</div>
	<!--轮播-->
...
<ul> 
    ...
    %>
                 <%
                  ...
                  {       
                      string MoRenPic = "../../../Admin/UpLoadPics/201404090618510I)YWZT5(X_6}~D(JVLRGV_S.jpg";
              %>
...
<!--信息介绍，嵌套在轮播里面-->
<div class="message">
		    <img src="../images1/startss.png" />
             
			<div class="message-right">
				<div class="m-1 m-2">星级:</div>
...
<div class="gonglve">
	<img src="../images/gonglve.png" />

	<div id="gonglve">
		
			<input type="button" class="active" value="马蜂窝" />
			<input  type="button" class="TabButton"  value="同程" />
			<input  type="button"  class="TabButton"  value="本站" />
			<input  type="button"  class="TabButton"  value="携程"/>
			<input type="button"  class="TabButton"  value="欣欣" />
        		...
        		<li>
        			...
        			<div class="spot-right">
        				...
        				<%
        				 ...
        				 %>
        				<span id="spotTime"><%=MaFengWoStrSplit.Rows[i]["PublishTime"].ToString()%></span>
        				<p><%=Content%>...</p>
        				<a href=<%=MaFengWoStrSplit.Rows[i]["StrategyUrl"].ToString() %>>详细信息</a>
        ...
        <div class="Con" >
        	<ul>
        		...
        		<li>
        			...
        			<div class="spot-right">
        				<h3><%=TongChenStrSplit.Rows[i]["StrategyTitle"].ToString()%></h3>
        				 <%
                        if (AuthorUrl != "")
                        {
        				...
        				<span id="spotTime"><%=TongChenStrSplit.Rows[i]["PublishTime"].ToString()%></span>
        				<p><%=Content%>...</p>
        				<a href=<%=TongChenStrSplit.Rows[i]["StrategyUrl"].ToString() %>>详细信息</a>
        			</div><hr style="border:none;clear:both;"/>
        		</li>
        		<%
                        }
	...
	<ul>
        ...
        <div class="Con" >
        	<ul>
        		<li>
        			<div class="spot-left"><a href=""><img src="../images/02.jpg" style="width:190px;height:150px;"/></a></div>
        			<div class="spot-right">
        				<h3>攻略标题</h3>
        				<span class="Auto">作者：作者</span><span id="spotTime">2014-4-25</span>
       ...
       <div class="Con" >
        	...
        	<%
                if (XieChenStrSplit.Rows.Count > 0)
                {
                    for (int i = 0; i < XieChenStrSplit.Rows.Count; i++)
                    {
                        ...
                        if (XieChenStrSplit.Rows[i]["StrategyContent"].ToString().Length > 100)
                            Content = XieChenStrSplit.Rows[i]["StrategyContent"].ToString().Substring(0, 100);
                        else
                            Content = XieChenStrSplit.Rows[i]["StrategyContent"].ToString();
        	        ...
        	        %>
        		<li>
        			<div class="spot-left"><a href=""><img src="../images/01.jpg" style="width:190px;height:150px;"/></a></div>
        			<div class="spot-right">
                ...
                else if (PublishDT.Rows.Count > 0)
                {
        				...
        				<span id="spotTime"><%=XieChenStrSplit.Rows[i]["PublishTime"].ToString()%></span>
        				<p><%=Content%>...</p>
        				<a href=<%=XieChenStrSplit.Rows[i]["StrategyUrl"].ToString() %>>详细信息</a>
        			</div><hr style="border:none;clear:both;"/>
        		</li>
        		<%}
                }
        ...
        <div class="Con" >
        	...
        	<%
                if (XinXinStrSplit.Rows.Count > 0)
                {
        	     ...
        	     %>
        		<li>
        			<div class="spot-left"><a href=""><img src="../images/two.jpg" style="width:190px;height:150px;"/></a></div>
        			<div class="spot-right">
        				<h3><%=XieChenStrSplit.Rows[i]["StrategyTitle"].ToString()%></h3>
        				<span id="spotTime"><%=XieChenStrSplit.Rows[i]["PublishTime"].ToString()%></span>
        				<p><%=Content%>...</p>
...
<div class="AlsoSee">
	...
	<ol class="AlsoOL">
		<li>
			<a href=""><img src="../../JuneThirdPages/EleImages/蝴蝶泉.jpg" /></a>
			<div class="also-right">
				<h3><a href="Scenery.aspx?SceneryID=34">蝴蝶泉</a></h3>
				<ul class="mess">
				<li>地址：十里画廊旁边</li>
				<li>景点门票：30￥</li>
				<li>开放时间：全天</li>
		...
		<li style="margin-top:10px;">
			<a href=""><img src="../EleImages/七星公园.jpg" style=""/></a>
			<div class="also-right">
				<h3><a href="Scenery.aspx?SceneryID=67">七星公园</a></h3>
				<ul class="mess">
				<li>地址：七星区七星路1号</li>
				<li>景点门票：75￥</li>
		...
		<li style="margin-top:10px;">
			<a ><img src="../EleImages/龙胜梯田.jpg" style=""/></a>
			<div class="also-right">
				<h3><a href="Scenery.aspx?SceneryID=111">龙脊梯田</a></h3>
				<ul class="mess">
				<li>地址：桂林市七星区</li>
				<li>景点门票：80￥</li>
				<li>开放时间：全天</li>
	...
	<a href="" ><img src="../images/refresh1.png" style="float:right;margin-right:10px;"/></a>
 </div>
...
<div class="otherComment">
		<img src="../images1/voice1.png" />



	<div id="otherDis">
	<input type="button" class="activ" value="同程" />
	<input type="button" value="驴妈妈" />
    

	<div id="disContent1" style="display:block;">
        <div id="discussTop">
        <%
        ...
        %>
        	<div class="discuss-span1">
        		<h1><%=_TongChenSatisfaction%></h1>
        		<p>满意度</p>
        	</div>


        	<div class="discuss-span2">
        		<h1><%=_TongChenRecommentRate%></h1>
        		<span class="span2-t">游客推荐</span>
        	</div>
        	...
        	<div class="discuss-span4">
        		<span class="span4-t">性价比：<%=_TongChenXingJiaBi%></span>
        		<span class="span4-t">服务：<%=_TongChenService%></span>
        		<span class="span4-t">便捷：<%=_TongChenConvenient%></span>
        	</div><hr style="border:none;clear:both;"/>
        ...
        <div id="discussBottom">
            ...
            %>
        		<li>
        			<div class="DBleft"><img src="../images/person3.png" style="width:74px;height:74px;"/>
       
        			</div>
        			<div class="DBright">
        				<p class="Timee"><a href=""><%=TongChenDT.Rows[i]["PublisherNickName"].ToString()%></a>
        				评价了
        				<a href=""><%=Name %></a>
        				...
        				<hr style="border:1px dashed #d2d0d0;width:520px;margin-top:5px;margin-bottom:10px;" />
        				 	<p>
        				 	<span >服务：<em style="color:#32b16c;"><%=TongChenDT.Rows[i]["SeverScore"].ToString() %></em></span>
        	                <span >便捷：<em style="color:#32b16c;"><%=TongChenDT.Rows[i]["ConvenientScore"].ToString() %></em></span>
        	                <span >优惠：<em style="color:#32b16c;"><%=TongChenDT.Rows[i]["DiscountScore"].ToString() %></em></span>

        	                </p>
        				<p><%=TongChenDT.Rows[i]["Assessment_Content"].ToString()%></p>
	...
	<div id="disContent2">
        ...
        <div id="discuss" >
        	<h1 class="fen">好评率 <%=_LvMaMaTotalScore%></h1>
        	<div class="fenXinxi">
        	<span class="Xinxi">人气：<em style="color:#ffa63b;"><%=_LvMaMaPopurity%></em></span>
        	<span class="Xinxi">规模：<em style="color:#ffa63b;"><%=_LvMaMaScale%></em></span>
        	<span class="Xinxi">观光：<em style="color:#ffa63b;"><%=_LvMaMaSightSeeing%></em></span>
        	<span class="Xinxi">服务：<em style="color:#ffa63b;"><%=_LvMaMaService%></em></span>
        </div>
        </div>
        ...
        <div class="disBottom">
        	...
        	<%
        		...
        		<li>
        	    <div class="disBLeft">
				<a href=""><img class="yonghu" src="../images/person2.jpg" style="width:91px;height:83px;"/></a>
				<a href=""><p style="margin-left:13px;margin-top:10px;"><%=LvMaMaDT.Rows[i]["PublisherNickName"].ToString() %></a></p>
				</div>
        			<div class="disBRight">
        				<p>
            <span class="Xinxi">人气：<em style="color:#32b16c;"><%=LvMaMaDT.Rows[i]["Popurity"].ToString()%></em></span>
        	<span class="Xinxi">规模：<em style="color:#32b16c;"><%=LvMaMaDT.Rows[i]["Scale"].ToString()%></em></span>
        	<span class="Xinxi">观光：<em style="color:#32b16c;"><%=LvMaMaDT.Rows[i]["SightSeeing"].ToString()%></em></span>
        	<span class="Xinxi">服务：<em style="color:#32b16c;"><%=LvMaMaDT.Rows[i]["Service"].ToString()%></em></span></p>
        	<p class="Bdis"><%=LvMaMaDT.Rows[i]["Assessment_Content"].ToString()%></p>
        	<a href="">查看全文>></a>
        	<div class="TimeLove">
        	<span class="LT-1"></span>
        	<span class="LT-3"><%=LvMaMaDT.Rows[i]["Assessment_Time"].ToString()%></span></div>
        			</div>
...
<div class="Discuss">
	...
	<ul class="Dis">
		<li>
			<div class="Dis-left">
				<a href=""><img class="yonghu" src="../images/person.png" style="width:64px;height:79px"/></a>
				<a href=""><p style="margin-left:13px;margin-top:10px;">用户名</a></p>
				</div>
			<div class="Dis-right">
				<p style="color:#e60012;">评分：5分<img src="../images/star-3.png" style="margin-left:10px;"/>
...
border-color:#4d90fe;
        ...
        <div id="diabox3" style="display:none;">
               ...
               <!--链接到推荐页面--> <a href="Rotes.aspx"><input type="submit" id="input5" value=" " onClick="goToSee()"/></a>
