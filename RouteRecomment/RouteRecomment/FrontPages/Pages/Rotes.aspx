<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Rotes.aspx.cs" Inherits="RouteRecomment.FrontPages.Pages.Rotes" %>
...
var scrollbar = null;
  ...
  <!--百度地图容器-->
  <div style="float:left;border:#ccc solid 1px;width:767px;height:511px;margin-left:20px;" id="dituContent"></div>  <hr style="border:none;clear:both;"/>
</div>
                    ...
                    <div class="spot-right">
                        <!--<h3>攻略标题</h3>
                            <span class="Auto"><a href="">作者：作者很多作者点击</a></span>
                             ...
                             <p><%=ShenLue%>...</p>
                             <span class="gonglveMore"><a href=<%=Url %>>详细信息</a></span>
