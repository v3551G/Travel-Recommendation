...
namespace RouteRecomment.FrontPages.Index.Page
{
    public partial class SubPage : System.Web.UI.Page
    {
        ...
        public DataTable DTOtherStraSplit;
        ...
        public static String GetScenery()
        {
            ...
            for (int k = 0; k < UseList.Count; k++)
            {
                ...
                if (SceDT.Rows[0]["SceneryIntro"].ToString().Length > 20)
                {
                    if (SceDT.Rows[0]["SceneryIntro"].ToString().Contains("\n"))
                        InfoList[k * 6 + 1] = SceDT.Rows[0]["SceneryIntro"].ToString().Replace("\n", ":").Substring(0, 20);
                    else
                        InfoList[k * 6 + 1] = SceDT.Rows[0]["SceneryIntro"].ToString().Substring(0, 20);
                }
                else
                {
                    if (SceDT.Rows[0]["SceneryIntro"].ToString().Contains("\n"))
                    InfoList[k * 6 + 1] = SceDT.Rows[0]["SceneryIntro"].ToString().Replace("\n", ":");
                        ...
                        InfoList[k * 6 + 1] = SceDT.Rows[0]["SceneryIntro"].ToString();
        ...
        public String GetHotel()
        {
            ...
            for (int k = 0; k < UseList.Count; k++)
            {
                ...
                if( HtlDT.Rows[0]["HotelIntroduction"].ToString().Length>20)
                      InfoList[k * 6 + 1] = HtlDT.Rows[0]["HotelIntroduction"].ToString().Substring(0, 20);
                else
                    InfoList[k * 6 + 1] = HtlDT.Rows[0]["HotelIntroduction"].ToString();
        ...
        public String GetRestaurant()
        {
            ...
            for (int k = 0; k < UseList.Count; k++)
            {
                ...
                if (_ResDT.Rows[0]["Introduction"].ToString().Length > 20)
                {
                    if (_ResDT.Rows[0]["Introduction"].ToString().Contains("\n"))
                        InfoList[k * 6 + 1] = _ResDT.Rows[0]["Introduction"].ToString().Replace("\n", ":").Substring(0, 20);
                    else
                        InfoList[k * 6 + 1] = _ResDT.Rows[0]["Introduction"].ToString().Substring(0, 20);
                }
                else
                {
                    if (_ResDT.Rows[0]["Introduction"].ToString().Contains("\n"))
                        ...
                        InfoList[k * 6 + 1] = _ResDT.Rows[0]["Introduction"].ToString();
        ...
        public String GetShop()
        {
            ...
            for (int k = 0; k < UseList.Count; k++)
            {
                ...
                if (_MallDT.Rows[0]["Introduction"].ToString().Length>20)
                   InfoList[k * 6 + 1] = _MallDT.Rows[0]["Introduction"].ToString().Substring(0, 20);
                else
                    InfoList[k * 6 + 1] = _MallDT.Rows[0]["Introduction"].ToString();
        ...
        public String GetEntertain()
        {
            ...
            for (int k = 0; k < UseList.Count; k++)
            {
                ...
                if (_EnterDT.Rows[0]["Introduction"].ToString().Length>20)
                     InfoList[k * 6 + 1] = _EnterDT.Rows[0]["Introduction"].ToString().Substring(0, 20);
                else
                    InfoList[k * 6 + 1] = _EnterDT.Rows[0]["Introduction"].ToString();
        ...
        public static String GetTypeAndID(String LatLon)
        {
            ...
            if (LatLon.Contains("|"))
            {
                ...
                {
                    Res += "../../Pages/Scenery.aspx?SceneryID=";
