<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="scenery.aspx.cs" Inherits="RouteRecomment.JuneThirdPages.Pages.Scenery" %>
...
<div class="all">
 ...
 <div id="focus">
    ...
    %>
        <li>
        <a href="" target="_blank" title=""><img alt="" src=<%=PicUrl %> />
        <div class="place">
                <%=Name%>
        </div>
        </a>
    ...
    <%
        ...
        { 
        %>
        <li><a href="" target="_blank" title=""><img alt="" src="../images/01.jpg" /><div class="place">
                 <%=Name%>
        </div></a></li>
    <li><a href="" target="_blank" title=""><img alt="" src="../images/02.jpg" /><div class="place">
                 <%=Name%>
        </div></a></li>
    <li><a href="" target="_blank" title=""><img alt="" src="../images/03.jpg" /><div class="place">
                <%=Name%>
        </div></a></li>
    <li><a href="" target="_blank" title=""><img alt="" src="../images/04.jpg" /><div class="place">
                <%=Name%>
        </div></a></li>
    <li><a href="" target="_blank" title=""><img alt="" src="../images/05.jpg" /><div class="place">
                <%=Name%>
        </div></a></li>
...
<div class="gonglve">
	...
	<div id="gonglve">
			...
			<input class="TabButton" type="button" value="同城" />
			<input class="TabButton" type="button" value="欣欣" />
            ...
            <asp:ScriptManager ID="ScriptManager1"  runat="server"  AsyncPostBackTimeout="0"  >
	         ...
	         <%  
              ...
              { %>
               <center>
                      <div id="Div2"><img src="../images/notie.png" />对不起，暂时无攻略！</div>
                    </center>
              <%
                 }
              else
        		...
        		<li>
        			...
        			<div class="spot-right">
        				...
        				<%
        				 ...
        				 %>
        				 <span id="Span1"><%=MaFengWoStrSplit.Rows[i]["PublishTime"].ToString()%></span>
        				<p><%=Content%>......</p>
...
<div class="AlsoSee">
	...
	<ol class="AlsoOL">
		...
		<li style="margin-top:10px;">
			<a href="Scenery.aspx?SceneryID=67"><img src="../EleImages/七星公园.jpg" style=""/></a>
			<div class="also-right">
				<h3>七星公园</h3>
				<ul class="mess">
				<li>地址：七星区七星路1号</li>
		...
		<li style="margin-top:10px;">
			<a href="Scenery.aspx?SceneryID=111"><img src="../EleImages/龙胜梯田.jpg" style=""/></a>
			<div class="also-right">
				<h3>龙脊梯田</h3>
				<ul class="mess">
				<li>地址：桂林市七星区</li>
...
<div class="otherComment">
		<img src="../images/voice1.png" />



		<div id="otherDis">
	<input type="button" class="activ" value="同城" />
...
<hr style="border:1px solid #dddada;"/>
        ...
        <div style="width:100%;height:70px;position:relative;">
        	...
        	<div class="discuss-span4">
        		...
        		<div class="span4-t">
                        ...
                        <dl class="span4-t-father">
                                

                                <dt class="span4-t-son1">94.00%<div class="zi1"></div><span class="span4-t-border"></span>
                                </dt>
                                <dd class="span4-t-son2"><div class="zi1"></div><span class="span4-t-border2"></span></dd>
                        </dl>
                   </div>
        ...
        <div id="discussBottom">
            ...
            %>
        		<li>
        			<div class="DBleft"><img src="../images/person3.png" style="width:74px;height:74px;"/></div>
        			<div class="DBright">
        				<p class="Timee"><a href=""><%=TongChenDT.Rows[i]["PublisherNickName"].ToString()%></a>评价了<a href=""><%=Name %></a><img src="../images/startSS.jpg"/><img src="../images/startSS.jpg"/><img src="../images/startSS.jpg"/><img src="../images/starhui1.png"/><img src="../images/starhui2.png"/></p>
   ...
   <style>
    ...
    <%
       ...
       %>   
                           <center>
                      <div id="Div1"><img src="../images/notie.png" />对不起，暂时无评论！</div>
                    </center>
                    <%
        }
        else
        ...
        <div id="discuss" >
        	...
        	<div class="fenXinxi">
                ...
                <div class="xinxizong">
        	<div class="Xinxi">人气：
                        <img src="../images/aixin1.png"  style="width:10px;height:10px;"/><img src="../images/aixin1.png"  style="width:10px;height:10px;"/><img src="../images/aixin1.png"  style="width:10px;height:10px;"/><img src="../images/aixin1.png"  style="width:10px;height:10px;"/><img src="../images/aixin2.png"  style="width:10px;height:10px;"/>

                        <em style="color:#ffa63b;margin-left:20px;"><%=_LvMaMaPopurity%></em>
                </div>
        	<div class="Xinxi">规模：
                        <img src="../images/aixin1.png"  style="width:10px;height:10px;"/><img src="../images/aixin1.png"  style="width:10px;height:10px;"/><img src="../images/aixin1.png"  style="width:10px;height:10px;"/><img src="../images/aixin1.png"  style="width:10px;height:10px;"/><img src="../images/aixin2.png"  style="width:10px;height:10px;"/>

                        <em style="color:#ffa63b;margin-left:20px;"><%=_LvMaMaScale%></em>
                </div>
        	<div class="Xinxi">观光：
                        <img src="../images/aixin1.png"  style="width:10px;height:10px;"/><img src="../images/aixin1.png"  style="width:10px;height:10px;"/><img src="../images/aixin1.png"  style="width:10px;height:10px;"/><img src="../images/aixin1.png"  style="width:10px;height:10px;"/><img src="../images/aixin2.png"  style="width:10px;height:10px;"/>

                        <em style="color:#ffa63b;margin-left:20px;"><%=_LvMaMaSightSeeing%></em>
                </div>
        	<div class="Xinxi">服务：
                        <img src="../images/aixin1.png"  style="width:10px;height:10px;"/><img src="../images/aixin1.png"  style="width:10px;height:10px;"/><img src="../images/aixin1.png"  style="width:10px;height:10px;"/><img src="../images/aixin1.png"  style="width:10px;height:10px;"/><img src="../images/aixin2.png"  style="width:10px;height:10px;"/>

                        <em style="color:#ffa63b;margin-left:20px;"><%=_LvMaMaService%></em>
                </div>
        ...
        <div class="disBottom">
        	<ol>
				...
				<p id="user1"><a href="" style=""><%=LvMaMaDT.Rows[i]["PublisherNickName"].ToString() %></a></p>
        			...
        			<div class="disBRight">
        				<em>总体评价:<img src="../images/aixin1.png"  style="width:10px;height:10px;"/><img src="../images/aixin1.png"  style="width:10px;height:10px;"/><img src="../images/aixin1.png"  style="width:10px;height:10px;"/><img src="../images/aixin1.png"  style="width:10px;height:10px;"/><img src="../images/aixin2.png"  style="width:10px;height:10px;"/></em>
        				<hr style="border:1px dashed #d2d0d0;width:520px;margin-top:5px;margin-bottom:10px;" />
        				<p><span class="Xinxi">人气：<em style="color:#32b16c;"><%=LvMaMaDT.Rows[i]["Popurity"].ToString()%></em></span>
		...
		<li>
			...
			<div class="Dis-right">
				<p style="color:#e60012;">评分：5分<img src="../images/star-3.png" style="margin-left:10px;"/>
					...
					<img src="../images/star-3.png"/>
					<img src="../images/star-3hui1.png"/>
                                        <img src="../images/star-3hui2.png"/>
				</p>
