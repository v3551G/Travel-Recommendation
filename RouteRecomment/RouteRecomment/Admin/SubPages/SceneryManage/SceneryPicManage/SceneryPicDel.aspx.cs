...
{
    public partial class SceneryPicDel : System.Web.UI.Page
    {
        private String rqid = "";
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                Response.Write("document.location.href='SceneryPicList.aspx';");
        ...
        protected void deleteThis()
        {
            ...
            {  
                ...
                for (int i = 0; i < delWitch.Length - 1; i++)
                {
                    ...
                    if (_PicInfoBLL.DelScePicByID(delid) && _PicInfoBLL.DelPicByID(delid))
                        isTrue = true;
                    else
                        isTrue = false;
                ...
                if (!(isTrue == false))
                {
                    ...
                    Response.Write("document.location.href='SceneryPicList.aspx?SceneryID="+SceneryID+"';");
                    Response.Write("</script>");
                }
                else
                {
