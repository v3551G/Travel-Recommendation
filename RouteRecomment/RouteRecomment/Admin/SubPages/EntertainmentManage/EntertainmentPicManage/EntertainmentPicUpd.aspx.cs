...
{  
    public partial class EntertainmentPicUpd : System.Web.UI.Page
    {
        ...
        protected void btAdd_Click(object sender, EventArgs e)
        {
                ...
                if (this.txtImgUrl.FileName.Trim() != "")
                {
                    ...
                    else
                    {
                        ...
                        if (_PicInfoBLL.AddPic(_PicInfo))
                        {
                            ...
                            //根据市ID向市图片表中插入一张图片
                            if (_PicInfoBLL.AddEnterPic(EntertainmentID, PicID))
                            {
                                Response.Write("<script language='javascript'>"); //"CityInfoDel.aspx?CityID=" + delWitch;
                                Response.Write("alert('图片添加成功');");
                                Response.Write("document.location.href='EntertainmentPicList.aspx?EntertainmentID=" + EntertainmentID.ToString() + "&CityID=" + CityID.ToString() + "'");
                                Response.Write("</script>");                                   
            ...
            catch (Exception ex)
            {
                ...
                Response.Write("document.location.href='EntertainmentList.aspx?EntertainmentID=" + EntertainmentID.ToString() + "&CityID" + CityID.ToString() + "'");
                Response.Write("</script>");
            }
