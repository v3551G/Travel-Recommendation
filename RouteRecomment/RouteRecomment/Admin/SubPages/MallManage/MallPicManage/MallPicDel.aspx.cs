...
{
    public partial class MallPicDel : System.Web.UI.Page
    {
        private String rqid = "";
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                Response.Write("document.location.href='MallPicList.aspx';");
        ...
        protected void deleteThis()
        {
            ...
            try
            {
                ...
                for (int i = 0; i < delWitch.Length - 1; i++)
                {
                    ...
                    if (_PicInfoBLL.DelMallPic(delid) && _PicInfoBLL.DelPicByID(delid))
                    {
                        isTrue = true;
                    }
                    else
                ...
                if (!(isTrue == false))
                {
                    ...
                    Response.Write("document.location.href='MallPicList.aspx?CityID=" + CityID.ToString() + "&MallID=" + MallID.ToString() + "';");
                    Response.Write("</script>");
                }
                else
                {
